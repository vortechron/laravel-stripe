<template>
    <div class="font-sans antialiased min-h-screen bg-white lg:bg-gray-100">
                            ...
                            <div class="mt-6 bg-white sm:rounded-lg shadow-sm overflow-hidden">
                                <div class="px-6 py-4">
                                    ...
                                    <template v-if="collectsVat || collectsBillingAddress">
                                        <div class="mt-6 md:flex items-center">
                                            <span class="md:w-1/3 mr-10 text-gray-800 text-sm font-semibold">{{ __('Country') }}</span>
                                        ...
                                        <template v-if="(addingVatNumber && vatComplicit) || collectsBillingAddress">
                                            ...
                                            <div class="mt-6 md:flex items-center">
                                                <label for="address" class="md:w-1/3 mr-10 text-gray-800 text-sm font-semibold">{{ __('Address') }}</label>
                                            ...
                                            <div class="mt-6 md:flex items-center">
                                                <label for="state" class="md:w-1/3 mr-10 text-gray-800 text-sm font-semibold">{{ __('State / County') }}</label>
                                            ...
                                            <div class="mt-6 md:flex items-center">
                                                <label for="postal_code" class="md:w-1/3 mr-10 text-gray-800 text-sm font-semibold">{{ __('Zip / Postal Code') }}</label>
                                    ...
                                    <div class="bg-white sm:rounded-lg shadow-sm overflow-hidden">
                                        <div class="px-6 py-4">
                                            ...
                                            <template v-if="updatingPaymentMethod && (collectsVat || collectsBillingAddress)">
                                                ...
                                                <div class="mt-6 md:flex items-center">
                                                    <label for="city" class="md:w-1/3 mr-10 text-gray-800 text-sm font-semibold">{{ __('City') }}</label>
                                        ...
                                        <div class="px-6 mt-4" v-if="updatingPaymentMethod">
                                            <info-messages v-if="hasUnpaidInvoices()">
                                ...
                                <div class="px-6 py-4 bg-white sm:rounded-lg shadow-sm">
                                    <div class="max-w-2xl text-sm text-gray-600">
                                        {{ __('Your next payment of :amount will be processed on :date.', {
                                            ...
                                            date: formatDate($page.props.nextPayment.date)
                                        }) }}
                                    </div>
                                </div>
                            </div>
        ...
        <modal v-if="showModal" ref="modal" title="Confirm Billing Action" :max-width="800" @closed="showModal = false">
            <template #default>
                {{ confirmText }}
            </template>
